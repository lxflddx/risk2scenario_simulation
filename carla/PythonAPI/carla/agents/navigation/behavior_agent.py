...
class BehaviorAgent(Agent):
    ...
    def run_step(self, debug=False):
        ...
        elif self.incoming_waypoint is not None and self.incoming_waypoint.is_junction and (self.incoming_direction == RoadOption.LEFT or self.incoming_direction == RoadOption.RIGHT):
            control = self._local_planner.run_step(
