...
class LocalPlanner(object):
    ...
    def _init_controller(self, opt_dict):
        ...
        self._sampling_radius = self._target_speed * 1 / 3.6  # 1 seconds horizon 把速度从km/h转换为m/s
        self._min_distance = self._sampling_radius * self.MIN_DISTANCE_PERCENTAGE # 判断是否到达下一个目标点值是90%的速度
        self._max_brake = 0.3
